...
namespace Thalassophobia.Items.Tier2
{
    public class AbilityCooldownReduced : ItemBase<AbilityCooldownReduced>
    {
        ...
        public override GameObject ItemModel => Plugin.assetBundle.LoadAsset<GameObject>("ImplantModel.prefab");

        public override Sprite ItemIcon => Plugin.assetBundle.LoadAsset<Sprite>("ImplantIcon.png");
