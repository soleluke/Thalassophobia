...
namespace Thalassophobia.Items.Tier2
{
    public class DotDamageUp : ItemBase<DotDamageUp>
    {
        ...
        public override GameObject ItemModel => Plugin.assetBundle.LoadAsset<GameObject>("Assets/Assembly/MyAssets/Models/CompoundModel.prefab");

        public override Sprite ItemIcon => Plugin.assetBundle.LoadAsset<Sprite>("Assets/Assembly/MyAssets/Icons/CompoundIcon.png");
