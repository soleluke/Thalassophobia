...
namespace Thalassophobia.Items.Tier2
{
    public class HealingShields : ItemBase<HealingShields>
    {
        ...
        public override GameObject ItemModel => Plugin.assetBundle.LoadAsset<GameObject>("BotModel.prefab");

        public override Sprite ItemIcon => Plugin.assetBundle.LoadAsset<Sprite>("BotsIcon.png");
