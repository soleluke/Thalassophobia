...
namespace Thalassophobia.Items.Tier1
{
    public class WispSummon : ItemBase<WispSummon>
    {
        ...
        public override void Init(ConfigFile config)
        {
            ...
            spawnCard = Addressables.LoadAssetAsync<CharacterSpawnCard>("RoR2/Base/LunarWisp/cscWisp.asset").WaitForCompletion();
        }
        ...
        private void SummonWisp(CharacterMaster owner)
        {
            ...
            directorSpawnRequest.onSpawnedServer = new System.Action<SpawnCard.SpawnResult>(delegate (SpawnCard.SpawnResult spawnResult)
            {
                if (spawnResult.success && spawnResult.spawnedInstance)
                {
                    ...
                    wisp.inventory.GiveItem(FriendlyWispHelper.instance.ItemDef, 1 + tier1Broken + tier2Broken * 3 + tier3Broken * 10);;
                    ...
                    wisp.onBodyDeath.AddListener(() =>
                    {
                        ...
                        owner.inventory.GiveItem(Tier1.WispSummonBroken.instance.ItemDef);
                        CharacterMasterNotificationQueue.PushItemTransformNotification(owner,
                           this.ItemDef.itemIndex, Tier1.WispSummonBroken.instance.ItemDef.itemIndex, CharacterMasterNotificationQueue.TransformationType.Default);
